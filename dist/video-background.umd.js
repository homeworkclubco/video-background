(function(h,a){typeof exports=="object"&&typeof module<"u"?a(exports):typeof define=="function"&&define.amd?define(["exports"],a):(h=typeof globalThis<"u"?globalThis:h||self,a(h.VideoBackground={}))})(this,(function(h){"use strict";const a={src:"",autoplay:!0,muted:!0,loop:!0,mobile:!1,volume:1,"start-at":0,"end-at":0,"play-button":!1,"mute-button":!1,"seek-bar":!1,poster:null,"aspect-ratio":"16/9","no-cookie":!0,"fit-box":!1,lazy:!1,"always-play":!1,"force-on-low-battery":!1,title:"Video background","video-id":"","unlisted-hash":""},x=/(?:youtube\.com\/(?:[^\/]+\/.+\/|(?:v|e(?:mbed)?)\/|.*[?&]v=)|youtu\.be\/|youtube-nocookie\.com\/embed\/)([^"&?\/\s]{11})/i,V=/(?:vimeo\.com\/(?:video\/|channels\/(?:\w+\/)?|groups\/(?:[^\/]*)\/videos\/|)(\d+)(?:|\/\?))/i,A=/\.(mp4|webm|ogv|ogm|ogg|avi|m4v|mov|qt)(\?.*)?$/i;function y(r){if(!r)return null;const t=r.match(x);if(t&&t[1])return{id:t[1],type:"youtube",link:r};const e=r.match(V);if(e&&e[1]){const s={id:e[1],type:"vimeo",link:r},n=/\/[^\/\:\.]+(\:|\/)([^:?\/]+)\s?$/,o=/(\?|&)h=([^=&#?]+)/,d=r.match(n),l=r.match(o);return d?s.unlisted=d[2]:l&&(s.unlisted=l[2]),s}return r.match(A)?{id:r,type:"html5",link:r}:null}function b(){return/Android|iPhone|iPad|iPod|webOS|BlackBerry|IEMobile|Windows Phone/i.test(navigator.userAgent)}const C=`
  :host {
    display: block;
    position: relative;
    overflow: hidden;
